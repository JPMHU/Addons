local CheckBoxTables = {
	...
	["Green Items Roll Automation"] = {
		[0] = "LazyPigCheckboxGroupGreenAutoRoll",
		[1] = { "LazyPigCheckbox113", "Need", "Does not include ZG coins or AQ scarabs" },
		[2] = { "LazyPigCheckbox114", "Greed", "Does not include ZG coins or AQ scarabs"  },
		[3] = { "LazyPigCheckbox115", "Pass", "Does not include ZG coins or AQ scarabs"  }
	},
	...
	["Naxxramas Roll Automation"] = {
		...
		[1] = { "LazyPigCheckbox110", "Need" },
		[2] = { "LazyPigCheckbox111", "Greed" },
		[3] = { "LazyPigCheckbox112", "Pass" }
	},
	
	["Ahn'Qiraj Roll Automation"] = {
		[0] = "LazyPigCheckboxGroupAQRoll",
		[1] = { "LazyPigCheckbox13", "Need", "Red Mount isn't included in the automatic rolls, nice try though" },
		[2] = { "LazyPigCheckbox14", "Greed", "My mom said that i'am special" },
		[3] = { "LazyPigCheckbox15", "Pass", "Too many mounts already, and idols is only for the talented singers" }
	},
	
	["Ahn'Qiraj Mounts (no red)"] = {
		[0] = "LazyPigCheckboxGroupAQMRoll",
	...
	["Battlegrounds Automation"] = {
		...
		[6] = { "LazyPigCheckbox55", "Block BG Quest Sharing" }
	},
	
	["Salvation, Spirit and Intellect Remover"] = {
	...
	["Single Choice Rules"] = {
		...
		[12] = { "LazyPigCheckbox103", "Terrain distance while in Naxxramas", "Min while in naxx and max elsewhere"}
	},
...
function LazyPig_CreateOptionsFrame()
	...
	fs_title:SetText("_LazyPig Options Hosq and Jaakko edition")
	...
	local str = "Salvation, Spirit and Intellect Remover"
	...
	frame.cbgroup_naxxroll = CheckBoxGroup(frame, 500, -45, str, CheckBoxTables[str])
	
	local str = "Ahn'Qiraj Roll Automation"
	frame.cbgroup_aqroll = CheckBoxGroup(frame, 500, -105, str, CheckBoxTables[str])
	
	local str = "Ahn'Qiraj Mounts (no red)"
	frame.cbgroup_aqroll = CheckBoxGroup(frame, 500, -165, str, CheckBoxTables[str])
	
	local str = "Green Items Roll Automation"
	frame.cbgroup_aqroll = CheckBoxGroup(frame, 500, -225, str, CheckBoxTables[str])
